...
import { IAccess, IBirth, ICrossing, ILossReason, IPig, IPigType, IPigWeight, IRace, IRole, IRoleAccess, IStage, IStallion, ITaskType, IUbication, IfertilizationType } from "@/interfaces";
