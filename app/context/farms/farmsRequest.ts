...
import { IAccess, IBirth, ICrossing, ILossReason, IPig, IPigStage, IPigTask, IPigType, IPigWeight, IRace, IRole, IRoleAccess, IStage, IStageTaskType, IStallion, ITaskType, IUbication, IfertilizationType } from "@/interfaces";
