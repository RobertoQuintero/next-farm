...
import { IAccess, IBirth, ICrossing, ILossReason, IPig, IPigType, IRace, IRole, IRoleAccess, IStage, IStallion, ITaskType, IUbication, IfertilizationType } from "@/interfaces";
